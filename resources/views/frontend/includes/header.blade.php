        ...
        <div class="container">
          <div class="topbar-left xs-hide">
            <div class="topbar-widget">
              ...
              <div class="topbar-widget">
                <a href="#"><i class="fa fa-clock-o"></i>Lundi à Vendredi : 08:00 - 12:00 / 13:30 - 18:00 Samedi 08:00 -
          ...
          <div class="col-md-12">
            <div class="de-flex sm-pt10">
              ...
              <div class="de-flex-col">
                ...
                <!--================================================== -->
                <!-- After login user menu with dropdown code start -->
                <!--================================================== -->
                <!-- 
                  <div class="de-flex-col header-col-mid">
                    <ul id="mainmenu">
                      <li>
                        <a class="menu-item" href="#"> <i class="fa fa-user" aria-hidden="true"></i> &nbsp;&nbsp;User</a>
                      <ul>
                        <li>
                ...
                <!--================================================== -->
                <!-- After login user menu with dropdown code ends -->
                <!--================================================== -->
