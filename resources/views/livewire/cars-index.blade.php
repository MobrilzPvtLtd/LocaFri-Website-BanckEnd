                ...
                <div class="col-lg-3">
                    ...
                    @php
                        ...
                        foreach ($vehicle as $key => $value) {
                            if ($value->Dprice < $minPrice) {
                                $dayPrice = $value->Dprice;
                            }
                            if ($value->wprice > $dayPrice) {
                                $minPrice = $value->wprice;
                            }
                            if ($value->mprice > $minPrice) {
                    ...
                    <div class="item_filter_group">
                        ...
                        <div class="price-input">
                            <div class="field">
                                <span>Min</span>
                                <input type="number" class="input-min" wire:model="Dprice" min="0"
                                    value="">
                            </div>
                            <div class="field">
                                <span>Max</span>
                                <input type="number" class="input-max" wire:model="mprice" min="0"
                                    value="">
                            </div>
                        </div>
                        <div class="slider">
                        ...
                        <div class="range-input">
                            <input type="range" class="range-min" wire:model="minPrice" min="0"
                                max="2000" value="0" step="1">
                            <input type="range" class="range-max" wire:model="maxPrice" min="0"
                                max="2000" value="2000" step="1">
                        </div>
                    </div>
                </div>
