        ...
        <div class="card-body">
            <div class="row">
                    ...
                    @if ($booking->transaction)
                        <p><strong>Payment Status:</strong>
                            @if ($booking->transaction->full_payment_paid)
                                <span class="">Full Paid</span>
                            @else
                                <span class="">Partial Payment</span>
                            @endif
                        </p>
                ...
                <div class="col-md-6">
                    ...
                    <p><strong>Daily Price:</strong> CHF {{ $booking->Dprice }}</p>
                    <p><strong>Weekly Price:</strong>CHF {{ $booking->wprice }}</p>
                    <p><strong>Monthly Price:</strong>CHF {{ $booking->mprice }}</p>
